	...
	<div class="newsletter-footer">
		<div class="container newsletter-container">
			<div class="newsletter-footer-text col-xs-12 col-md-12 col-lg-8 col-centered">
				<div class="col-xs-12 col-md-8"><h2>Signup to receive our newsletter</h2></div><div class="col-xs-9 col-md-4 newsletter-button col-centered-mob"><button>SUBSCRIBE</button></div>
			</div>
		</div>
	</div>		
<?php else : ?>
