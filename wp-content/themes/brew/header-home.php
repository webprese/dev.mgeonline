              ...
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-responsive-collapse">
				...
				<div class="top container col-xs-12 col-sm-12 col-lg-12">
						...
						<div class="header-icons">
							<ul>
								<li class="header-icon-facebook"><a href="https://www.facebook.com/mgemanagementexperts" target="_blank"><img src="<?php bloginfo( 'url' ) ?>/wp-content/themes/brew/library/images/blank-image.png" alt=" " /></a></li>
								<li class="header-icon-twitter"><a href="https://twitter.com/MGEOnline" target="_blank"> <img src="<?php bloginfo( 'url' ) ?>/wp-content/themes/brew/library/images/blank-image.png" alt=" " /></a></li>
								<li class="header-icon-linkedin"><a href="https://www.linkedin.com/company/mge-management-experts-inc-" target="_blank"><img src="<?php bloginfo( 'url' ) ?>/wp-content/themes/brew/library/images/blank-image.png" alt=" " /></a></li>
							</ul>
						</div>
				</div>
